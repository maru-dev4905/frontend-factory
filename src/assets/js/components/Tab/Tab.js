export default function wvTab() {
  ...
  tabs.each(function () {
    ...
    tabBtn.on("click", function () {
      ...
      // 탭 버튼 활성화 상태 변경
      $(this).siblings(".wv_tab_btn").removeClass("active");
      $(this).addClass("active");

      // 탭 패널 활성화 상태 변경
      $(this).closest(".wv_tab").find(" > .wv_tab_content > .wv_tab_panel").removeClass("active");
      $(this).closest(".wv_tab").find(" > .wv_tab_content > .wv_tab_panel").eq(idx).addClass("active");
    });
